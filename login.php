...
<head>
    ...
    <title>IBMRD Payment System</title>
...
<body >
    <div class="container">
    <img src="214634167_116279694042600_3806890484890620068_n.png"  alt="" id="ibmrd" srcset="" width="25%">
         <div class="row ">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                            ...
                            <div class="panel-body" style="background-color: #E2E2E2; margin-top:50px; border:solid 3px #0e0e0e;">
							  <h3 class="myhead">IBMRD Fees Payment System</h3>
